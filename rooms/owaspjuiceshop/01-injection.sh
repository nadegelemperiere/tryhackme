...
curl -s -X GET "http://$target_ip/rest/admin/application-version" -b "/work/1-cookies.txt" -L > /dev/null
curl -s -X GET "http://$target_ip/rest/admin/application-configuration" -b "/work/1-cookies.txt" -L > /dev/null
