...
curl -X POST "http://$target_ip:8088/register.php" -b /work/7-cookies.txt -v -L -H "Content-Type: multipart/form-data; boundary=--------------------------346104398912025331583998084524" --data-binary @${scriptpath}/7-data/darren.txt
...
curl -X POST "http://$target_ip:8088/register.php" -b /work/7-cookies.txt -v -L -H "Content-Type: multipart/form-data; boundary=--------------------------346104398912025331583998084524" --data-binary @${scriptpath}/7-data/arthur.txt
